...
assessmentButton.addEventListener( // イベント検知設定の追加
  ...
  () => { // 無名関数、アロー関数
    ...
    // 診断結果表示エリアの作成
    resultDivision.innerText = '' //resultのdivタグを空文字で上書きし、空にしている
    ...
    anchor.innerText = '#あなたのいいところを投稿' //ボタンの文章

    tweetDivision.appendChild(anchor) // divの子要素として追加
    
    const script = document.createElement('script') //scriptタグ作成
    script.setAttribute('src', "https://platform.twitter.com/widgets.js")//src属性追加
